      ...
      <div className="mx-auto max-w-7xl px-6 py-8 space-y-8">
        ...
        <section className="grid gap-4 md:grid-cols-4">
          <div className="rounded-2xl border border-green-900 bg-green-950/20 p-5">
            ...
            <div className="mt-2 text-xl font-semibold">Publish status</div>
            <p className="mt-2 text-sm text-zinc-400">
              Add your confirmed mint-authority status here once verified on-chain.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-yellow-900 bg-yellow-950/20 p-5">
            ...
            <div className="mt-2 text-xl font-semibold">Publish status</div>
            <p className="mt-2 text-sm text-zinc-400">
              Show whether freeze authority is revoked to improve investor confidence.
            </p>
          </div>

          <div className="rounded-2xl border border-blue-900 bg-blue-950/20 p-5">
            <div className="text-sm text-blue-300">LP Status</div>
            <div className="mt-2 text-xl font-semibold">Publish lock proof</div>
            <p className="mt-2 text-sm text-zinc-400">
              Share LP lock or burn proof here so visitors can verify liquidity status.
            </p>
          </div>
        ...
        <section className="grid gap-6 md:grid-cols-2">
          <section className="rounded-3xl border border-zinc-800 bg-zinc-950 p-6">
            ...
            <ul className="space-y-3 text-zinc-300">
              ...
              <li>• Transparency data is updated live from on-chain sources.</li>
            </ul>
          </section>
